...
当她跟我说了这个情况以后，我觉得这个问题可以用计算机的图像处理技术来解决。只需要对种子进行拍照，剩下的工作都可以计算机来完成，省时省力。

中间查找资料和试验的过程就不多赘述了，最终的结果是在ImageJ的帮助下，这个问题被轻松解决了。考虑到在网上几乎找不到介绍利用图像处理软件进行种子计数的资料，下面我把这个方法做一个介绍，希望能给遇到类似问题的人提供一些帮助。
